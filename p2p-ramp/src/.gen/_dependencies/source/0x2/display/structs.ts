...
export function isDisplay(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::display::Display` + '<'); }
...
export class Display<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V31}::display::Display`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = Display.$typeName; readonly $fullTypeName: `${typeof PKG_V31}::display::Display<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = Display.$isPhantom;

 readonly id: ToField<UID>; readonly fields: ToField<VecMap<String, String>>; readonly version: ToField<"u16">

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DisplayFields<T>, ) { this.$fullTypeName = composeSuiType( Display.$typeName, ...typeArgs ) as `${typeof PKG_V31}::display::Display<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.fields = fields.fields;; this.version = fields.version; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): DisplayReified<ToPhantomTypeArgument<T>> { return { typeName: Display.$typeName, fullTypeName: composeSuiType( Display.$typeName, ...[extractType(T)] ) as `${typeof PKG_V31}::display::Display<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: Display.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => Display.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Display.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => Display.fromBcs( T, data, ), bcs: Display.bcs, fromJSONField: (field: any) => Display.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => Display.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => Display.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => Display.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => Display.fetch( client, T, id, ), new: ( fields: DisplayFields<ToPhantomTypeArgument<T>>, ) => { return new Display( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): Display<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isDisplay(data.bcs.type)) { throw new Error(`object at is not a Display object`); }
...
export function isDisplayCreated(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::display::DisplayCreated` + '<'); }
...
export class DisplayCreated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V31}::display::DisplayCreated`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = DisplayCreated.$typeName; readonly $fullTypeName: `${typeof PKG_V31}::display::DisplayCreated<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = DisplayCreated.$isPhantom;

 readonly id: ToField<ID>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DisplayCreatedFields<T>, ) { this.$fullTypeName = composeSuiType( DisplayCreated.$typeName, ...typeArgs ) as `${typeof PKG_V31}::display::DisplayCreated<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): DisplayCreatedReified<ToPhantomTypeArgument<T>> { return { typeName: DisplayCreated.$typeName, fullTypeName: composeSuiType( DisplayCreated.$typeName, ...[extractType(T)] ) as `${typeof PKG_V31}::display::DisplayCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: DisplayCreated.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => DisplayCreated.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DisplayCreated.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => DisplayCreated.fromBcs( T, data, ), bcs: DisplayCreated.bcs, fromJSONField: (field: any) => DisplayCreated.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => DisplayCreated.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => DisplayCreated.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => DisplayCreated.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => DisplayCreated.fetch( client, T, id, ), new: ( fields: DisplayCreatedFields<ToPhantomTypeArgument<T>>, ) => { return new DisplayCreated( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): DisplayCreated<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isDisplayCreated(data.bcs.type)) { throw new Error(`object at is not a DisplayCreated object`); }
...
export function isVersionUpdated(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::display::VersionUpdated` + '<'); }
...
export class VersionUpdated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V31}::display::VersionUpdated`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = VersionUpdated.$typeName; readonly $fullTypeName: `${typeof PKG_V31}::display::VersionUpdated<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = VersionUpdated.$isPhantom;

 readonly id: ToField<ID>; readonly version: ToField<"u16">; readonly fields: ToField<VecMap<String, String>>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: VersionUpdatedFields<T>, ) { this.$fullTypeName = composeSuiType( VersionUpdated.$typeName, ...typeArgs ) as `${typeof PKG_V31}::display::VersionUpdated<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.version = fields.version;; this.fields = fields.fields; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): VersionUpdatedReified<ToPhantomTypeArgument<T>> { return { typeName: VersionUpdated.$typeName, fullTypeName: composeSuiType( VersionUpdated.$typeName, ...[extractType(T)] ) as `${typeof PKG_V31}::display::VersionUpdated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: VersionUpdated.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => VersionUpdated.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => VersionUpdated.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => VersionUpdated.fromBcs( T, data, ), bcs: VersionUpdated.bcs, fromJSONField: (field: any) => VersionUpdated.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => VersionUpdated.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => VersionUpdated.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => VersionUpdated.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => VersionUpdated.fetch( client, T, id, ), new: ( fields: VersionUpdatedFields<ToPhantomTypeArgument<T>>, ) => { return new VersionUpdated( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): VersionUpdated<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isVersionUpdated(data.bcs.type)) { throw new Error(`object at is not a VersionUpdated object`); }
