...
export function validateOutcome( tx: Transaction, outcome: TransactionObjectInput ) { return tx.moveCall({ target: `${PUBLISHED_AT}::payment::validate_outcome`, arguments: [ obj(tx, outcome) ], }) }
