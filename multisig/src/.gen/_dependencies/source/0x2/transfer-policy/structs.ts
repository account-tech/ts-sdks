...
export function isTransferRequest(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::transfer_policy::TransferRequest` + '<'); }
...
export class TransferRequest<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V31}::transfer_policy::TransferRequest`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TransferRequest.$typeName; readonly $fullTypeName: `${typeof PKG_V31}::transfer_policy::TransferRequest<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TransferRequest.$isPhantom;

 readonly item: ToField<ID>; readonly paid: ToField<"u64">; readonly from: ToField<ID>; readonly receipts: ToField<VecSet<TypeName>>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferRequestFields<T>, ) { this.$fullTypeName = composeSuiType( TransferRequest.$typeName, ...typeArgs ) as `${typeof PKG_V31}::transfer_policy::TransferRequest<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.item = fields.item;; this.paid = fields.paid;; this.from = fields.from;; this.receipts = fields.receipts; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TransferRequestReified<ToPhantomTypeArgument<T>> { return { typeName: TransferRequest.$typeName, fullTypeName: composeSuiType( TransferRequest.$typeName, ...[extractType(T)] ) as `${typeof PKG_V31}::transfer_policy::TransferRequest<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: TransferRequest.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => TransferRequest.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferRequest.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => TransferRequest.fromBcs( T, data, ), bcs: TransferRequest.bcs, fromJSONField: (field: any) => TransferRequest.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => TransferRequest.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferRequest.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => TransferRequest.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => TransferRequest.fetch( client, T, id, ), new: ( fields: TransferRequestFields<ToPhantomTypeArgument<T>>, ) => { return new TransferRequest( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): TransferRequest<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTransferRequest(data.bcs.type)) { throw new Error(`object at is not a TransferRequest object`); }
...
export function isTransferPolicy(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::transfer_policy::TransferPolicy` + '<'); }
...
export class TransferPolicy<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V31}::transfer_policy::TransferPolicy`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TransferPolicy.$typeName; readonly $fullTypeName: `${typeof PKG_V31}::transfer_policy::TransferPolicy<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TransferPolicy.$isPhantom;

 readonly id: ToField<UID>; readonly balance: ToField<Balance<ToPhantom<SUI>>>; readonly rules: ToField<VecSet<TypeName>>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferPolicyFields<T>, ) { this.$fullTypeName = composeSuiType( TransferPolicy.$typeName, ...typeArgs ) as `${typeof PKG_V31}::transfer_policy::TransferPolicy<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.balance = fields.balance;; this.rules = fields.rules; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TransferPolicyReified<ToPhantomTypeArgument<T>> { return { typeName: TransferPolicy.$typeName, fullTypeName: composeSuiType( TransferPolicy.$typeName, ...[extractType(T)] ) as `${typeof PKG_V31}::transfer_policy::TransferPolicy<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: TransferPolicy.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => TransferPolicy.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicy.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => TransferPolicy.fromBcs( T, data, ), bcs: TransferPolicy.bcs, fromJSONField: (field: any) => TransferPolicy.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => TransferPolicy.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicy.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => TransferPolicy.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicy.fetch( client, T, id, ), new: ( fields: TransferPolicyFields<ToPhantomTypeArgument<T>>, ) => { return new TransferPolicy( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): TransferPolicy<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTransferPolicy(data.bcs.type)) { throw new Error(`object at is not a TransferPolicy object`); }
...
export function isTransferPolicyCap(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::transfer_policy::TransferPolicyCap` + '<'); }
...
export class TransferPolicyCap<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V31}::transfer_policy::TransferPolicyCap`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TransferPolicyCap.$typeName; readonly $fullTypeName: `${typeof PKG_V31}::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TransferPolicyCap.$isPhantom;

 readonly id: ToField<UID>; readonly policyId: ToField<ID>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferPolicyCapFields<T>, ) { this.$fullTypeName = composeSuiType( TransferPolicyCap.$typeName, ...typeArgs ) as `${typeof PKG_V31}::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.policyId = fields.policyId; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TransferPolicyCapReified<ToPhantomTypeArgument<T>> { return { typeName: TransferPolicyCap.$typeName, fullTypeName: composeSuiType( TransferPolicyCap.$typeName, ...[extractType(T)] ) as `${typeof PKG_V31}::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: TransferPolicyCap.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => TransferPolicyCap.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyCap.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => TransferPolicyCap.fromBcs( T, data, ), bcs: TransferPolicyCap.bcs, fromJSONField: (field: any) => TransferPolicyCap.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => TransferPolicyCap.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicyCap.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => TransferPolicyCap.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicyCap.fetch( client, T, id, ), new: ( fields: TransferPolicyCapFields<ToPhantomTypeArgument<T>>, ) => { return new TransferPolicyCap( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): TransferPolicyCap<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTransferPolicyCap(data.bcs.type)) { throw new Error(`object at is not a TransferPolicyCap object`); }
...
export function isTransferPolicyCreated(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::transfer_policy::TransferPolicyCreated` + '<'); }
...
export class TransferPolicyCreated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V31}::transfer_policy::TransferPolicyCreated`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TransferPolicyCreated.$typeName; readonly $fullTypeName: `${typeof PKG_V31}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TransferPolicyCreated.$isPhantom;

 readonly id: ToField<ID>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferPolicyCreatedFields<T>, ) { this.$fullTypeName = composeSuiType( TransferPolicyCreated.$typeName, ...typeArgs ) as `${typeof PKG_V31}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TransferPolicyCreatedReified<ToPhantomTypeArgument<T>> { return { typeName: TransferPolicyCreated.$typeName, fullTypeName: composeSuiType( TransferPolicyCreated.$typeName, ...[extractType(T)] ) as `${typeof PKG_V31}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: TransferPolicyCreated.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => TransferPolicyCreated.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyCreated.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => TransferPolicyCreated.fromBcs( T, data, ), bcs: TransferPolicyCreated.bcs, fromJSONField: (field: any) => TransferPolicyCreated.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => TransferPolicyCreated.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicyCreated.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => TransferPolicyCreated.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicyCreated.fetch( client, T, id, ), new: ( fields: TransferPolicyCreatedFields<ToPhantomTypeArgument<T>>, ) => { return new TransferPolicyCreated( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): TransferPolicyCreated<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTransferPolicyCreated(data.bcs.type)) { throw new Error(`object at is not a TransferPolicyCreated object`); }
...
export function isTransferPolicyDestroyed(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::transfer_policy::TransferPolicyDestroyed` + '<'); }
...
export class TransferPolicyDestroyed<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V31}::transfer_policy::TransferPolicyDestroyed`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TransferPolicyDestroyed.$typeName; readonly $fullTypeName: `${typeof PKG_V31}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TransferPolicyDestroyed.$isPhantom;

 readonly id: ToField<ID>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferPolicyDestroyedFields<T>, ) { this.$fullTypeName = composeSuiType( TransferPolicyDestroyed.$typeName, ...typeArgs ) as `${typeof PKG_V31}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TransferPolicyDestroyedReified<ToPhantomTypeArgument<T>> { return { typeName: TransferPolicyDestroyed.$typeName, fullTypeName: composeSuiType( TransferPolicyDestroyed.$typeName, ...[extractType(T)] ) as `${typeof PKG_V31}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: TransferPolicyDestroyed.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => TransferPolicyDestroyed.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyDestroyed.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => TransferPolicyDestroyed.fromBcs( T, data, ), bcs: TransferPolicyDestroyed.bcs, fromJSONField: (field: any) => TransferPolicyDestroyed.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => TransferPolicyDestroyed.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicyDestroyed.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => TransferPolicyDestroyed.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicyDestroyed.fetch( client, T, id, ), new: ( fields: TransferPolicyDestroyedFields<ToPhantomTypeArgument<T>>, ) => { return new TransferPolicyDestroyed( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): TransferPolicyDestroyed<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTransferPolicyDestroyed(data.bcs.type)) { throw new Error(`object at is not a TransferPolicyDestroyed object`); }
...
export function isRuleKey(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::transfer_policy::RuleKey` + '<'); }
...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V31}::transfer_policy::RuleKey`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = RuleKey.$typeName; readonly $fullTypeName: `${typeof PKG_V31}::transfer_policy::RuleKey<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = RuleKey.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: RuleKeyFields<T>, ) { this.$fullTypeName = composeSuiType( RuleKey.$typeName, ...typeArgs ) as `${typeof PKG_V31}::transfer_policy::RuleKey<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): RuleKeyReified<ToPhantomTypeArgument<T>> { return { typeName: RuleKey.$typeName, fullTypeName: composeSuiType( RuleKey.$typeName, ...[extractType(T)] ) as `${typeof PKG_V31}::transfer_policy::RuleKey<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: RuleKey.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => RuleKey.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => RuleKey.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => RuleKey.fromBcs( T, data, ), bcs: RuleKey.bcs, fromJSONField: (field: any) => RuleKey.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => RuleKey.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => RuleKey.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => RuleKey.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => RuleKey.fetch( client, T, id, ), new: ( fields: RuleKeyFields<ToPhantomTypeArgument<T>>, ) => { return new RuleKey( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): RuleKey<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isRuleKey(data.bcs.type)) { throw new Error(`object at is not a RuleKey object`); }
