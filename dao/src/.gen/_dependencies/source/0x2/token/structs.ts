...
export function isToken(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::token::Token` + '<'); }
...
export class Token<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V31}::token::Token`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = Token.$typeName; readonly $fullTypeName: `${typeof PKG_V31}::token::Token<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = Token.$isPhantom;

 readonly id: ToField<UID>; readonly balance: ToField<Balance<T>>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TokenFields<T>, ) { this.$fullTypeName = composeSuiType( Token.$typeName, ...typeArgs ) as `${typeof PKG_V31}::token::Token<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.balance = fields.balance; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TokenReified<ToPhantomTypeArgument<T>> { return { typeName: Token.$typeName, fullTypeName: composeSuiType( Token.$typeName, ...[extractType(T)] ) as `${typeof PKG_V31}::token::Token<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: Token.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => Token.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Token.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => Token.fromBcs( T, data, ), bcs: Token.bcs, fromJSONField: (field: any) => Token.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => Token.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => Token.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => Token.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => Token.fetch( client, T, id, ), new: ( fields: TokenFields<ToPhantomTypeArgument<T>>, ) => { return new Token( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): Token<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isToken(data.bcs.type)) { throw new Error(`object at is not a Token object`); }
...
export function isTokenPolicyCap(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::token::TokenPolicyCap` + '<'); }
...
export class TokenPolicyCap<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V31}::token::TokenPolicyCap`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TokenPolicyCap.$typeName; readonly $fullTypeName: `${typeof PKG_V31}::token::TokenPolicyCap<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TokenPolicyCap.$isPhantom;

 readonly id: ToField<UID>; readonly for: ToField<ID>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TokenPolicyCapFields<T>, ) { this.$fullTypeName = composeSuiType( TokenPolicyCap.$typeName, ...typeArgs ) as `${typeof PKG_V31}::token::TokenPolicyCap<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.for = fields.for; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TokenPolicyCapReified<ToPhantomTypeArgument<T>> { return { typeName: TokenPolicyCap.$typeName, fullTypeName: composeSuiType( TokenPolicyCap.$typeName, ...[extractType(T)] ) as `${typeof PKG_V31}::token::TokenPolicyCap<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: TokenPolicyCap.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => TokenPolicyCap.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TokenPolicyCap.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => TokenPolicyCap.fromBcs( T, data, ), bcs: TokenPolicyCap.bcs, fromJSONField: (field: any) => TokenPolicyCap.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => TokenPolicyCap.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => TokenPolicyCap.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => TokenPolicyCap.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => TokenPolicyCap.fetch( client, T, id, ), new: ( fields: TokenPolicyCapFields<ToPhantomTypeArgument<T>>, ) => { return new TokenPolicyCap( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): TokenPolicyCap<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTokenPolicyCap(data.bcs.type)) { throw new Error(`object at is not a TokenPolicyCap object`); }
...
export function isTokenPolicy(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::token::TokenPolicy` + '<'); }
...
export class TokenPolicy<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V31}::token::TokenPolicy`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TokenPolicy.$typeName; readonly $fullTypeName: `${typeof PKG_V31}::token::TokenPolicy<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TokenPolicy.$isPhantom;

 readonly id: ToField<UID>; readonly spentBalance: ToField<Balance<T>>; readonly rules: ToField<VecMap<String, VecSet<TypeName>>>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TokenPolicyFields<T>, ) { this.$fullTypeName = composeSuiType( TokenPolicy.$typeName, ...typeArgs ) as `${typeof PKG_V31}::token::TokenPolicy<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.spentBalance = fields.spentBalance;; this.rules = fields.rules; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TokenPolicyReified<ToPhantomTypeArgument<T>> { return { typeName: TokenPolicy.$typeName, fullTypeName: composeSuiType( TokenPolicy.$typeName, ...[extractType(T)] ) as `${typeof PKG_V31}::token::TokenPolicy<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: TokenPolicy.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => TokenPolicy.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TokenPolicy.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => TokenPolicy.fromBcs( T, data, ), bcs: TokenPolicy.bcs, fromJSONField: (field: any) => TokenPolicy.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => TokenPolicy.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => TokenPolicy.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => TokenPolicy.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => TokenPolicy.fetch( client, T, id, ), new: ( fields: TokenPolicyFields<ToPhantomTypeArgument<T>>, ) => { return new TokenPolicy( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): TokenPolicy<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTokenPolicy(data.bcs.type)) { throw new Error(`object at is not a TokenPolicy object`); }
...
export function isActionRequest(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::token::ActionRequest` + '<'); }
...
export class ActionRequest<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V31}::token::ActionRequest`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = ActionRequest.$typeName; readonly $fullTypeName: `${typeof PKG_V31}::token::ActionRequest<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = ActionRequest.$isPhantom;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ActionRequestFields<T>, ) { this.$fullTypeName = composeSuiType( ActionRequest.$typeName, ...typeArgs ) as `${typeof PKG_V31}::token::ActionRequest<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): ActionRequestReified<ToPhantomTypeArgument<T>> { return { typeName: ActionRequest.$typeName, fullTypeName: composeSuiType( ActionRequest.$typeName, ...[extractType(T)] ) as `${typeof PKG_V31}::token::ActionRequest<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: ActionRequest.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => ActionRequest.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ActionRequest.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => ActionRequest.fromBcs( T, data, ), bcs: ActionRequest.bcs, fromJSONField: (field: any) => ActionRequest.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => ActionRequest.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => ActionRequest.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => ActionRequest.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => ActionRequest.fetch( client, T, id, ), new: ( fields: ActionRequestFields<ToPhantomTypeArgument<T>>, ) => { return new ActionRequest( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 name: this.name,amount: this.amount.toString(),sender: this.sender,recipient: fieldToJSON<Option<"address">>(`${Option.$typeName}<address>`, this.recipient),spentBalance: fieldToJSON<Option<Balance<T>>>(`${Option.$typeName}<${Balance.$typeName}<${this.$typeArgs[0]}>>`, this.spentBalance),approvals: this.approvals.toJSONField(),
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): ActionRequest<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isActionRequest(data.bcs.type)) { throw new Error(`object at is not a ActionRequest object`); }
...
export function isRuleKey(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::token::RuleKey` + '<'); }
...
export function isTokenPolicyCreated(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V31}::token::TokenPolicyCreated` + '<'); }
...
export class TokenPolicyCreated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V31}::token::TokenPolicyCreated`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TokenPolicyCreated.$typeName; readonly $fullTypeName: `${typeof PKG_V31}::token::TokenPolicyCreated<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TokenPolicyCreated.$isPhantom;

 readonly id: ToField<ID>; readonly isMutable: ToField<"bool">

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TokenPolicyCreatedFields<T>, ) { this.$fullTypeName = composeSuiType( TokenPolicyCreated.$typeName, ...typeArgs ) as `${typeof PKG_V31}::token::TokenPolicyCreated<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.isMutable = fields.isMutable; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TokenPolicyCreatedReified<ToPhantomTypeArgument<T>> { return { typeName: TokenPolicyCreated.$typeName, fullTypeName: composeSuiType( TokenPolicyCreated.$typeName, ...[extractType(T)] ) as `${typeof PKG_V31}::token::TokenPolicyCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: TokenPolicyCreated.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => TokenPolicyCreated.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TokenPolicyCreated.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => TokenPolicyCreated.fromBcs( T, data, ), bcs: TokenPolicyCreated.bcs, fromJSONField: (field: any) => TokenPolicyCreated.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => TokenPolicyCreated.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => TokenPolicyCreated.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => TokenPolicyCreated.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => TokenPolicyCreated.fetch( client, T, id, ), new: ( fields: TokenPolicyCreatedFields<ToPhantomTypeArgument<T>>, ) => { return new TokenPolicyCreated( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): TokenPolicyCreated<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTokenPolicyCreated(data.bcs.type)) { throw new Error(`object at is not a TokenPolicyCreated object`); }
